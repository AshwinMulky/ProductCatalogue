...
import com.globomart.catalogue.web.rest.errors.BadRequestAlertException;
import com.globomart.catalogue.web.rest.util.HeaderUtil;
import com.globomart.catalogue.web.rest.util.PaginationUtil;
...
public class ProductResource {
    ...
    public ResponseEntity<List<Product>> searchProducts(Pageable pageable, @RequestParam(required = false) ProductType type) {
        log.debug("REST request to search for Products");
        Page<Product> page = productService.search(pageable, type);
